CREATE DATABASE MyJoinsDB; 				    -- Завдання 3: Создайте базу данных с именем “MyJoinsDB”.
...
CREATE TABLE general						-- Завдання 4: В данной базе данных создайте 3 таблицы,
...
CREATE TABLE staff							-- Завдання 4: Во 2-й таблице содержатся ведомости о зарплате и должностях сотрудников: главный директор, менеджер, рабочий.
(
    person_id INT,
...
CREATE TABLE personal_data						-- Завдання 4: В 3-й таблице содержится информация о семейном положении, дате рождения, и месте проживания.
(
    person_id INT,
